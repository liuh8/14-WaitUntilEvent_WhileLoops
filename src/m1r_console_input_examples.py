...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         and HL.
"""  # T: 1. PUT YOUR NAME IN THE ABOVE LINE.

###############################################################################
# T: 2.  Read and run this program.  Then do the following problems,
